...
import vn.lequan.vivovideo.adapter.MovieAdapterHome;
...
//                    img_share.setImageResource(R.drawable.ic_chiase_click);
                                    onActionShareFacebook(itemMovie.getData().getMovie().getName(), itemMovie.getData().getMovie().getDescription(), AndroidUtils.gotoWebStore("vn.lequan.vivovideo"), itemMovie.getData().getMovie().getImage().getThumbnailUrl());
                                } else {
                                    share = true;
