...
public class VideoAdapterList extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Parcelable {
    ...
    public VideoAdapterList(FragmentManager fragmentManager, Context context, List<ScreenMenuItem> lstData, int numberColmns, boolean screenlist) {
